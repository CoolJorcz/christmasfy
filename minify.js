...
(function (document){
  ...
  function transformToChristmas(){
    ...
    document.getElementsByTagName('body')[0].style.backgroundImage = 'url("santa-claus-arrived.jpg")'
    ...
    document.getElementsByTagName('body')[0].addEventListener("click", function(e) {
      ...
      document.getElementsByTagName('body')[0].innerHTML += getRandomIcon(iconSource)
